...
class UNetEfficientNetV2Small(nn.Module):
    def __init__(self, num_classes=1, pretrained=True):
        ...
        self.decoder1 = self.conv_block(160, 128)
        self.decoder2 = self.conv_block(128 + 64, 64)
        self.decoder3 = self.conv_block(64 + 48, 48)
        self.decoder4 = self.conv_block(48 + 24, 24)
        ...
        self.up3 = nn.ConvTranspose2d(48, 48, kernel_size=2, stride=2)
        self.up4 = nn.ConvTranspose2d(24, 24, kernel_size=2, stride=2)
    ...
    def forward(self, x):
        ...
        dec5 = self.up4(dec4) 
        print(dec5.shape)
        return self.final_conv(dec5), bottleneck
